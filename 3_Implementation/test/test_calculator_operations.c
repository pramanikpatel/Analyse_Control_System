...
void test_quality_factor()
{
  TEST_ASSERT_EQUAL(0.866025, quality_factor(&zeta));
}
  
void test_rise_time()
{
  TEST_ASSERT_EQUAL(1.544804, rise_time(&zeta,&dam_freq));
}
  

  void test_overshoot()
{
  TEST_ASSERT_EQUAL(10.859988, overshoot(&zeta));
}
 ...
 void test_setling_time()
{
  ...
  TEST_ASSERT_EQUAL(4.000000, setling_time(&zeta,&nat_freq));
}
  
  void test_delay_time()
{

  TEST_ASSERT_EQUAL(0.810684, delay_time(&zeta,&nat_freq));
}
